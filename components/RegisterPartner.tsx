...
export function RegisterPartner() {
  ...
  return (
    <div className="max-w-2xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-gradient-to-r from-inybg via-blue-900 to-inybg flex justify-center items-center">
      <div className="max-w-2xl w-full mx-auto flex flex-col justify-center items-center">
        ...
        <h2 className="font-bold text-xl text-neutral-200 dark:text-neutral-200 text-center">
          ¡Convierte en Partner!
        </h2>
        <p className="text-neutral-300 text-sm max-w-sm mt-2 dark:text-neutral-300 text-center mx-auto">
          Bienvenido al registro de Partners en donde podrás acceder a los mejores beneficios.
        </p>
